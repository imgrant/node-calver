...
class ModifierVersion {
  ...
  inc(level) {
    ...
    if (parseInt(this[this.prop]) === -1) this[this.prop] = this.startFrom.toString();else this[this.prop] = (parseInt(this[this.prop]) + 1).toString();
    return this;
  }
  isValid(prop, v) {
    if (!v || typeof v != 'string' || this.reDigits.test(v)) return false;
...
class LocalDate {
  ...
  getWeek() {
    const d = new Date(this.date.getFullYear(), this.date.getMonth(), this.date.getDate());
